        ...
        <div className="p-4 space-y-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                {isAdmin && (
                    <button
                        onClick={openCreate}
                        className="flex shrink-0 items-center gap-2 px-4 py-2 text-sm font-medium bg-violet-600 hover:bg-violet-700 text-white rounded-lg transition-colors w-full sm:w-auto justify-center"
                    >
