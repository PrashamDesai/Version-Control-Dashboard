    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-xl border border-zinc-800/60 overflow-hidden">
                <div className="grid grid-cols-[1fr_auto_auto_auto] text-[11px] font-semibold text-zinc-500 uppercase tracking-wider px-4 py-3 bg-zinc-900/60 border-b border-zinc-800/60">
                    <span>User</span>
                                    ...
                                    <div className="flex justify-center px-4">
                                        {updatingId === u._id ? (
                                            ...
                                            <button
                                                ...
                                                className="w-7 h-7 rounded-lg flex items-center justify-center text-zinc-500 hover:text-red-400 hover:bg-red-500/10 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
